...
$(document).on("click", ".js-msgGroup", function() {
    $(".js-msgGroup, .js-newMsg").addClass("hidden-xs-up"), $(".js-conversation").removeClass("hidden-xs-up"), $(".modal-title").html('<a href="#" class="js-gotoMsgs">Back</a>'), $input.insertBefore(".js-modalBody")
}), $(function() {
    function o() {
    ...
    $input.remove(), $(".js-conversation").addClass("hidden-xs-up"), $(".js-msgGroup, .js-newMsg").removeClass("hidden-xs-up"), $(".modal-title").html("Messages")
    ...
    var n = $("#markdown-toc");
    $("#markdown-toc li").addClass("nav-item"), $("#markdown-toc li > a").addClass("nav-link");
    var a = $(window);
    n[0] && (o(), a.on("resize", o))
});