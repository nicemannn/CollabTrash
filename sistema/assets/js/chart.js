(function() {
    ...
    var s = e.helpers = {},
        ...
        C = (s.calculateScaleRange = function(t, i, e, s, n) {
            ...
            for (var c = Math.abs(l - r), u = y(c), d = Math.ceil(l / (1 * Math.pow(10, u))) * Math.pow(10, u), p = s ? 0 : Math.floor(r / (1 * Math.pow(10, u))) * Math.pow(10, u), f = d - p, m = Math.pow(10, u), x = Math.round(f / m);
                (x > a || 2 * x < a) && !h;)
                if (x > a) m *= 2, x = Math.round(f / m), x % 1 !== 0 && (h = !0);
                else if (n && u >= 0) {
                if (m / 2 % 1 !== 0) break;
                m /= 2, x = Math.round(f / m)
        ...
        w = (s.generateLabels = function(t, i, e, s) {
            ...
            easeInOutElastic: function(t) {
                var i = 1.70158,
                    e = 0,
                    s = 1;
                return 0 === t ? 0 : 2 == (t /= .5) ? 1 : (e || (e = 1 * (.3 * 1.5)), s < Math.abs(1) ? (s = 1, i = e / 4) : i = e / (2 * Math.PI) * Math.asin(1 / s), t < 1 ? -.5 * (s * Math.pow(2, 10 * (t -= 1)) * Math.sin((1 * t - i) * (2 * Math.PI) / e)) : s * Math.pow(2, -10 * (t -= 1)) * Math.sin((1 * t - i) * (2 * Math.PI) / e) * .5 + 1)
            },
            ...
            if (o || i) {
                if (this.activeElements = t, this.draw(), this.options.customTooltips && this.options.customTooltips(!1), t.length > 0)
                    if (this.datasets && this.datasets.length > 1) {
                        for (var a, h, r = this.datasets.length - 1; r >= 0 && (a = this.datasets[r].points || this.datasets[r].bars || this.datasets[r].segments, h = l(a, t[0]), h === -1); r--);
                        var c = [],
                            u = [],
                            d = function(t) {
                                var i, e, n, o, a, l = [],
                ...
                if (n(this.yLabels, function(i, e) {
                    ...
                    for (var i = this.valuesCount - 1; i >= 0; i--) {
                        ...
                        var o = this.labels.length,
                            ...
                            l = i < h || i > o - h,
                            r = i === h || i === o - h;
                        0 === i ? t.textAlign = "center" : i === a ? t.textAlign = "center" : i < a ? t.textAlign = "left" : t.textAlign = "right", r ? t.textBaseline = "middle" : l ? t.textBaseline = "bottom" : t.textBaseline = "top", t.fillText(this.labels[i], s.x, s.y)
                    }
                }
            }
        }
        ...
        i.Type.extend({
            ...
            getPointsAtEvent: function(t) {
                var i = e.getRelativePosition(t),
                    ...
                    a = [];
                return (o >= this.scale.valuesCount || o < 0) && (o = 0), s.distance <= this.scale.drawingArea && e.each(this.datasets, function(t) {
                    a.push(t.points[o])
                }), a
            },
            buildScale: function(t) {
